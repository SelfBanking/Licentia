...
const AccountDetails = () => {
    ...
    return <Grid container spacing={2} className={classes.accountGridStyle}>
                ...
                <CardContent>
                    <Grid container spacing={1}>
                        ...
                        <Grid container spacing={0}>
                            ...
                            <Grid item xs>
                                <Typography className={classes.coinworth} color="textSecondary" gutterBottom>
                                    $ 300.00
                                </Typography>
                            </Grid>
                        </Grid>
                        <Grid container spacing={1}>
                            <Grid item xs>
                                <Typography className={classes.amount} color="textSecondary" gutterBottom>
                                    1.23321
                                </Typography>
                            </Grid>
                            <Grid item xs>
                                <Typography className={classes.gain} color="textSecondary" gutterBottom>
                                    30%
                                </Typography>
                            </Grid>
                        </Grid>
